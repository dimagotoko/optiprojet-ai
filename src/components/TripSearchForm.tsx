        ...
        <form className="grid grid-cols-1 md:grid-cols-12 gap-2 sm:gap-4 items-center">
          <div className="relative md:col-span-3">
            <AddressInput
              ...
              defaultValue={initialSearch?.departure}
            />
          </div>
          ...
          <div className="relative md:col-span-3">
            <AddressInput
              ...
              defaultValue={initialSearch?.destination}
            />
          </div>
          ...
          <div className="relative md:col-span-1">
            ...
            <Input type="number" placeholder="1" className="pl-10 h-12 text-base" min="1" defaultValue={1} />
          </div>
