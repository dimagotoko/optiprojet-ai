  ...
  useEffect(() => {
    if (tripData) {
        ...
        tripForm.reset({
            ...
            options: tripData.options || { allowLargeBags: false, allowSmallBags: true, allowPets: false, isNonSmoking: true },
    ...
    <Form {...tripForm}>
      <form onSubmit={tripForm.handleSubmit(onSubmitTrip)} className="space-y-8">
        <Card className="w-full max-w-2xl mx-auto">
            <CardHeader>
            <CardTitle className="text-3xl font-bold">Modifier le trajet</CardTitle>
            <CardDescription>
